        ...
        <form enctype="multipart/form-data" class="layui-form" method="post" action="<%=request.getContextPath()%>/activities/save" onsubmit="return checkCondition();">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="MODALITIES_ID" name="MODALITIES_ID" class="valid" disabled="disabled">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <table id="fileTable">
                  		<tr><td><input id="file" type="file" lt="image" name="fil" onchange="showImg(this)" accept="image/*" lay-verify="nikename" disabled="disabled"/></td><td><img src="<%=request.getContextPath()%>/file/image?FILENAME=${pd.BACK_PATH}" alt="展位图片"  width="100px" id="image"/></td><td></td></tr>
                  	</table>
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.PEOPLE_LIMIT}" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.DAY_LIMIT}" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${pd.TOPIC}" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input class="layui-input" placeholder="开始日" name="START_TIME" id="start" lay-key="1" autocomplete="off" lay-verify="beginningDate" value="${pd.START_TIME}" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <input class="layui-input" placeholder="结束日" name="END_TIME" id="end" lay-key="2" autocomplete="off" lay-verify="endDate" value="${pd.END_TIME}" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <select id="goods" name="GOODS_ID" class="valid" lay-filter="goods" disabled="disabled">
                    <option value="">请选择</option>
    ...
    <script>
        ...
        $(".add1").click(function(){
       	...
       	$(".add").click(function(){
       		...
       		htmlgp+="<option value='${pi.PRIZEITEMS_ID}'>${pi.DESCRIPTION}</option>";
            </c:forEach>
       		...
       		layer.open({
           	  ...
           	  ,yes: function(index, layero){
           		...
           		if($("#PRIZEITEMS_ID_TEMP").val()!='' && $("#PRIZEITEMS_ID_PERCENT_TEMP").val()!=''){
           			...
           			$("#tbd").append(`<tr><td><input type="hidden" name="PRIZEITEMS_ID_PERCENT" value="`+iid+`_`+ipercent+`"/>`+iname+`</td><td>`+ipercent+`</td><td align="center"><button class="layui-btn layui-btn-primary delete" type="button">删除</button></td></tr>`);
                	$(".delete").click(function(){
                    	$(this).parent().parent().remove();
                    });
           			layer.close(index);
